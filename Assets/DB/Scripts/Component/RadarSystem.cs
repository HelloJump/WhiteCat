...
public enum Alignment0 { None,LeftTop, RightTop, LeftBot, RightBot ,MiddleTop ,MiddleBot}
...
public class RadarSystem : MonoBehaviour {
	...
	public Alignment0 PositionAlignment = Alignment0.None;// position alignment
